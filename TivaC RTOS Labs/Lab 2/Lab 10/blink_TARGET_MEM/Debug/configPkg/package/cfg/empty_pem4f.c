...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[8126];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/itzel/workspace_v9/blink_TARGET_MEM/Debug/configPkg/package/cfg/empty_pem4f");
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[2] = {
    ...
    {/* instance#1 */
        ...
        (xdc_UInt)0x0,  /* curCoreId */
        (xdc_UInt)0x0,  /* affinity */
        (xdc_runtime_Text_CordAddr)(xdc_runtime_Text_charTab__A+8038) /* __name */
    },
};
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1fbe;
