...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES)
	...
	"C:/ti/ccs910/ccs/tools/compiler/ti-cgt-arm_18.12.2.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me --include_path="C:/Users/itzel/workspace_v9/RTOS_Assignment" --include_path="C:/Users/itzel/workspace_v9/RTOS_Assignment" --include_path="C:/ti/tirtos_tivac_2_16_00_08/products/TivaWare_C_Series-2.1.1.71b" --include_path="C:/ti/tirtos_tivac_2_16_00_08/products/bios_6_45_01_29/packages/ti/sysbios/posix" --include_path="C:/ti/ccs910/ccs/tools/compiler/ti-cgt-arm_18.12.2.LTS/include" --define=ccs="ccs" --define=PART_TM4C123GH6PM --define=ccs --define=TIVAWARE -g --gcc --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-2092246367:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-2092246367-inproc

build-2092246367-inproc: ../empty.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-2092246367 ../empty.cfg
configPkg/compiler.opt: build-2092246367
configPkg/: build-2092246367
